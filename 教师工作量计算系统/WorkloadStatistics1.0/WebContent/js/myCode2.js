$(document).ready(function(){  // 等待Dom元素加载完毕
   $(".myForm").submit(function(){
	  ...
	  if(button.val() == "修改") {
		  ...
		  button.parent().prev().prev().prev().children().removeAttr("readonly");
		  button.parent().prev().prev().prev().children().removeAttr("style","");
		  button.parent().prev().prev().prev().prev().children().removeAttr("readonly");
		  button.parent().prev().prev().prev().prev().children().removeAttr("style","");
