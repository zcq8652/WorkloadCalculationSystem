...
<body>
	<form action="Jsp/toInitial"><input type="submit" value="提交审核" class="sub_box"></form>
	...
	<div id="export_word">
	    ...
	    while (it.hasNext()) {
	        ...
	        while (itOne.hasNext()) {
	        	...
	        	if(myCounts.size() == 0 && myOthers.size() == 0) {
		    		...
		    		<tr>
		    			...
		    			<% if(i == 0 ) {%>
		    			<td rowspan="<%=myCounts.size()+1%>">${time}</td>
		    			<%} %>
		    			<% if(i == 0 ) {%>
		    ...
		    if( j < 20 ) {
		    	...
		    	%><tr><c:forEach begin="0" end="10" step="1">
