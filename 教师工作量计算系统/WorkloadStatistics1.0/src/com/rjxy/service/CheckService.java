...
public class CheckService {
	...
	public String checkService() throws IOException {
		//创建数据库连接
		SqlUtil sqlUtil = new SqlUtil();
		//提取数据库中需要审核工作量的教师信息
		List<User> users = sqlUtil.selectAllStatusTeacher("1_2");
		//判断是否还有未审核教师
		if (users.size()==0) {
			return "<p>暂无需审核人员</p>";
		}
		...
		string+="<span style=\"color:#336199; margin-left:8px;\">是否通过审核:</span><input type=\"radio\" name=\"status\" value=\"3_2\" checked><span style=\"color:orange;\">是</span>";
		string+="<input type=\"radio\" name=\"status\" value=\"2_2\" style=\"margin-left:15px;\"><span style=\"color:orange;\">否</span></br>";
